...
def myNetwork():
    ...
    info( '*** Add hosts\n')
    h5 = net.addHost('h5', cls=Host, ip='40.0.0.1', defaultRoute=None)
    h6 = net.addHost('h6', cls=Host, ip='50.0.0.1', defaultRoute=None)
    h1 = net.addHost('h1', cls=Host, ip='30.0.0.1', defaultRoute=None)
    h2 = net.addHost('h2', cls=Host, ip='30.0.0.2', defaultRoute=None)
    h3 = net.addHost('h3', cls=Host, ip='30.0.0.3', defaultRoute=None)
    h4 = net.addHost('h4', cls=Host, ip='60.0.0.1', defaultRoute=None)
