...
private:
    ...
    {
        cout << "\n****************************************\n\n";
        cout << "Quick sort a: [00, 5, 3, 1, 6, 8, 3, 2] tombre. \n";
        bool hiba;
        vector<int> A = {00, 5, 3, 1, 6, 8, 3, 2 };
        int n = A.size();

        cout << "Kezdeti allapot: [00, 5, 3, 1, 6, 8, 3, 2] n = 7" << endl;
    ...
    void merge(vector<int> *A, int u, int m, int v)
    {
        int d = m - u;
        vector<int> Z;
        for(int i = 0; i < d; i++){Z.push_back(A->at(u+i));}
        int k = u;
        int i;
        int j;
